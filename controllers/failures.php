...
/**
 * Mail failures report controller.
 *
 * @category   Apps
 * @package    Mail_Report
...
class Failures extends ClearOS_Controller
{
    /**
    ...
    function index()
    {
        ...
        try {
            $data['data'] = $this->mail_report->get_delivery_failures();

            $data['key'] = lang('mail_report_failure');
            $data['value'] = lang('mail_report_count');
            $data['title'] = lang('mail_report_failures');
        } catch (Exception $e) {
